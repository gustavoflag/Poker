...
const jogadorOrders = require('../helpers/jogadorOrders.js');
...
exports.classificacao = async (req, res) => {
...
exports.classificacaoRookies = async (req, res) => {
  var ordem = req.params.ordem;
...
exports.classificacaoMes = (req, res) => {
...
exports.classificacaoTodosMeses = (req, res) => {
...
exports.classificacaoEtapa = (req, res) => {
...
exports.classificacaoTodasEtapas = (req, res) => {
...
exports.listarClassificacaoTodasEtapas = (req, res) => {
...
exports.classificacaoJogadorEtapa = (req, res) => {
  ClassificacaoEtapa.find({}, function (err, classificacoes) {
    if (err)
      return res.status(440).json(err);
...
exports.inserir = async (req, res) => {
  try {
    ...
    const jogador = await novoJogador.save();
...
exports.inserirLote = async (req, res) => {
  try {
    ...
    var count = 0;
    jogadores.forEach(async (jogadorBody) => {
...
exports.alterar = async (req, res) => {
  try {
    const jogador = await Jogador.findOneAndUpdate({ _id: req.params.jogadorId }, req.body, { new: true });
...
exports.excluirPontuacaoEtapas = async (req, res) => {
  try {
    const jogadores = await Jogador.find({});

    for (var jogador of jogadores) {
      jogador.pontuacaoEtapas = [];

      await jogador.save();
    }

    return res.json({ message: 'Pontuações excluídas' });
  } catch (err) {
    return res.status(440).json(err);
  }
};
...
//Funções
const classMes = (ano, mes, callback) => {
  var jogadores = [];
...
const classEtapa = (etapa, callback) => {
  var jogadores = [];
...
const gerarClassificacaoEtapa = (etapa, callback) => {
...
const classificacaoGeral = async (ordem) => {
...
const sortJogadores = (jogadores, ordem) => {
  try {
    switch (ordem) {
      case "P":
...
const getEstatisticasJogador = (jogador) => {
...
const encontraPosicao = (jogadorArray, nomeJogador) => {
